    <div class="form-group">
      ...
      <button type="button" class="btn btn-<?php if ($dataWanita->ktp_wanita) {
                                              echo "success";
                                            } else {
                                              echo "primary";
                                            } ?>" data-toggle="modal" data-target="#exampleModalKTPPRIA">
        <?php if ($dataWanita->ktp_wanita) {
    ...
    <div class="modal fade" id="exampleModalKTPPRIA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <?= form_open_multipart('home/nikah/wanita/ktp') ?>
          <form method="post">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">KTP Wanita</h5>
            </div>
            <div class="modal-body">
              <input class="form-control" type="file" name="ktp_wanita" id="">
            </div>
